...
public class CodeCovController {
    ...
    /**
     *
     * @param envCoverRequest   ...//123==========
     * @return
     */
    @RequestMapping(value = "/triggerEnvCov123", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    public HttpResult<Boolean> triggerEnvCov123(@RequestBody @Validated EnvCoverRequest envCoverRequest) {
        codeCovService.triggerEnvCov(envCoverRequest);
        return HttpResult.success();
